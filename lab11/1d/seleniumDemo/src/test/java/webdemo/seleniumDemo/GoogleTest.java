...
public class GoogleTest {
	...
	public void testTitlePage() {
		driver.get("https://whatgames.herokuapp.com/users/sign_up");
	}
	
	@Test
	public void registrationTest()
	{
		WebElement selectElement = driver.findElement(By.id("BirthMonth"));
		Select listBox = new Select(selectElement);
		int size1 = listBox.getOptions().size();	
		
		System.out.println("elementy: " + size1);
		assertEquals(size1, 13);
	}
