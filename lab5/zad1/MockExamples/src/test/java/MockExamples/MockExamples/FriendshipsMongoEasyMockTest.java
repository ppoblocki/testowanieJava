...
public class FriendshipsMongoEasyMockTest {
	...
	public void updatingWorksAsExpected(){
		...
		joe.name = "JoeUpdate";
		expect(friends.findByName("JoeUpdate")).andReturn(joe);
		replay(friends);
		assertThat(friends.findByName("JoeUpdate")).isEqualTo(joe);
	}
	...
	public void deleteWorksAsExpected(){
		...
		expect(friends.findByName("Joe")).andReturn(joe);
		joe = null;
		expect(friends.findByName("JoeUpdate")).andReturn(null);
		replay(friends);
		assertThat(friends.findByName("JoeUpdate")).isEqualTo(null);
	}
